...
ComputeMaiseStress::ComputeMaiseStress(LAMMPS *lmp, int narg, char **arg) :
...
ComputeMaiseStress::~ComputeMaiseStress()
{
  delete [] id_temp;
  delete [] vector;
  delete [] vptr;
...
double ComputeMaiseStress::compute_scalar()
{
...
void ComputeMaiseStress::compute_vector()
{
...
void ComputeMaiseStress::virial_compute(int n, int ndiag)
{
  int i,j;
...
void ComputeMaiseStress::reset_extra_compute_fix(const char *id_new)
{
  delete [] id_temp;
