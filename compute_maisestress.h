...
ComputeStyle(maisestress,ComputeMaiseStress)

#else

#ifndef LMP_COMPUTE_MAISESTRESS_H
#define LMP_COMPUTE_MAISESTRESS_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeMaiseStress : public Compute {
 public:
  ComputeMaiseStress(class LAMMPS *, int, char **);
  virtual ~ComputeMaiseStress();
  virtual void init();
